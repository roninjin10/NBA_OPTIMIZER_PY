...
test_player = Player(name='Kyle Anderson', team='SA', opp='CLE', position='PG/SG', salary=3000, dfs_site_id ={constants.dk: '152333'}, stat_projections=test_stat_projections, site_name=constants.dk)

pg1 = Player(name='Chris Paul', team='HOU', opp='NY', position='PG', salary=9000, dfs_site_id ={constants.dk: '152334'}, stat_projections=test_stat_projections, site_name=constants.dk)
pg2 = Player(name='George Hill', team='SAC', opp='PHO', position='PG/SG', salary=5000, dfs_site_id ={constants.dk: '152335'}, stat_projections=test_stat_projections, site_name=constants.dk)
sg1 = Player(name='Devin Booker', team='PHO', opp='SAC', position='SG', salary=8000, dfs_site_id ={constants.dk: '152336'}, stat_projections=test_stat_projections, site_name=constants.dk)
sg2 = Player(name='Danny Green', team='SA', opp='CLE', position='SG/SF', salary=4000, dfs_site_id ={constants.dk: '152337'}, stat_projections=test_stat_projections, site_name=constants.dk)
sf1 = Player(name='Trevor Ariza', team='HOU', opp='NY', position='SF', salary=5000, dfs_site_id ={constants.dk: '152338'}, stat_projections=test_stat_projections, site_name=constants.dk)
sf2 = Player(name='Jeff Green', team='CLE', opp='SA', position='SF/PF', salary=3800, dfs_site_id ={constants.dk: '152339'}, stat_projections=test_stat_projections, site_name=constants.dk)
pf1 = Player(name='Kevin Love', team='CLE', opp='SA', position='PF/C', salary=7500, dfs_site_id ={constants.dk: '152340'}, stat_projections=test_stat_projections, site_name=constants.dk)
pf2 = Player(name='Kristaps Porzingis', team='NY', opp='HOU', position='PF', salary=8800, dfs_site_id ={constants.dk: '152341'}, stat_projections=test_stat_projections, site_name=constants.dk)
c1 = Player(name='Alex Len', team='PHO', opp='SAC', position='C', salary=4100, dfs_site_id ={constants.dk: '152342'}, stat_projections=test_stat_projections, site_name=constants.dk)
c2 = Player(name='Pau Gasol', team='SA', opp='CLE', position='C', salary=5400, dfs_site_id ={constants.dk: '152343'}, stat_projections=test_stat_projections, site_name=constants.dk)
